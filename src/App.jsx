            ...
            <div className="service-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(170px, 1fr))", gap: 18, width: "100%", maxWidth: 680, margin: "0 auto" }}>
              {SERVICES.map(s => (
                <GlassCard
                  ...
                  onClick={() => {
                    if (s.status === "live") {
                      if (s.id === "visual") { setScreen("visual-designs"); return; }
                      if (s.id === "stationery") { setScreen("stationery-kit"); return; }
                      if (s.id === "studio") { setScreen("studio-hub"); return; }
                      if (s.id === "instant-alert") { setScreen("instant-alert"); return; }
