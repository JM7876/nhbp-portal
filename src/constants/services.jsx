...
export const SERVICES = [
  ...
  { id: "community-outreach", icon: "📣", label: "Community Outreach", desc: "Social media requests & instant alerts", gradient: `linear-gradient(135deg, ${NHBP.turquoise}22, ${NHBP.turquoise}08)`, status: "live" },
  { id: "diy-builder", icon: "✏️", label: "DIY Post Builder", desc: "Draft your own post — we'll review & publish", gradient: `linear-gradient(135deg, ${NHBP.maroonLight}22, ${NHBP.maroonLight}08)`, status: "live" },
